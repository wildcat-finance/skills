...
3. The starting base is `main` at `53fba06ad9501aa73879538f192ec09570a91c49`.
...
**Pull requests read.** The last merged pull requests touching
`plugins/hexaemeron/skills/fiat/` are `028dcdc8` (sync the prose-packet run
with main) and `8cc85686` (recover Fiat 497 on step-extension base), with
`0949a2e5` superseding issue 923's integration sync for current main. None
carries an unfinished item bearing on this topic. The 972 run's own carried
work is issue 1021 itself.

**Audit records.** The whole-set currency check,
`python3 plugins/hexaemeron/skills/fiat/scripts/audit_synopsis.py --check .`,
run from the target root, exits 0 and reports `committed=match` for all 20
sources, so a verified synopsis is the authoritative reading view. In-scope
...
The starting ref is `main` at `53fba06ad9501aa73879538f192ec09570a91c49`. The
...
- `plugins/hexaemeron/skills/fiat/scripts/hexctl.py` at
  `53fba06ad9501aa73879538f192ec09570a91c49`, lines 6705, 6773, 6844, 8260,
