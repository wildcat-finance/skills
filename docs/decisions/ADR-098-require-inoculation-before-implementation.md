# ADR-098: Require inoculation before implementation
...
[known-failure inoculation study](https://github.com/wildcat-finance/skills/blob/main/docs/known-failure-inoculation-study.md).
The delivery order and checks are in the
[runbook](https://github.com/wildcat-finance/skills/blob/main/plugins/hexaemeron/docs/known-failure-inoculation/runbook.md).
