# ADR-053: Keep dead-code discovery report-only
...
work landed that number and ADR-052 on `main`. The decision landed as ADR-053.
Historical ADR-051 mentions in the digest-pinned runbook refer to this record
and remain unchanged as receipt evidence.
