# ADR-062: Encode a closed agent-instruction model
...
The original Fiat runbook allocated this decision as ADR-051 before concurrent
work landed that number and ADR-052 through ADR-061 on `main`. The decision
lands as ADR-062. Historical ADR-051 mentions in the digest-pinned study and
runbook refer to this record and remain unchanged as receipt evidence.
