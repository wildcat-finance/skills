...
**Why.** Warden finding S1-R1-06, rebound to the current study digest after the 2026-09-06 study amendment adding section 11's eleventh refusal changed the digest every runbook amendment records. The defect and the replacement are unchanged; only the binding is new.
