# Obligation gate demonstration: integration projection

This projection refreshes current counts and input digests. The original
[record](demonstration-run.json) and [report](demonstration-evidence.md) remain
unchanged. All command outcomes, host details, dates and model observations
below are historical; this projection records no new execution or model call.
...
The current structural projection is
[`integration-projection.json`](integration-projection.json). Every count, digest, gate
...
| --- | --- | --- | --- | --- | --- | --- |
| `result-binding` | result binding | `check --only runtime` | 1 | 50 runtime binding rows | `PM095` | 14 |
...
- `tests/promise_machine_coverage.json`, SHA-256 `ed3656bb1139439d42472f8490ff168befb01950373246a9a53227113cee37c2`, 274116 bytes
- `tests/promise_machine_id_history.json`, SHA-256 `5b2aa6527205d5fa7f150fcdcd65540108f1da0be55881b8194f64f512b961e6`, 52900 bytes
- `tests/fixtures/promise-machine/composition/cases.json`, SHA-256 `d4981a119aee8942e3105c8cec936094b1556efd2c79a41242af34f8ea7d9298`, 26778 bytes
...
- `docs/promise-machine/obligation-gates/evaluation-run.json`, SHA-256 `20bbd8d7003cd6884009d6f357ec85cb87ec3a6be11aae9852ec90b4c0d49863`, 3231 bytes
...
- Standing decision record: `docs/decisions/ADR-088-bind-promise-obligations-to-gates.md`
