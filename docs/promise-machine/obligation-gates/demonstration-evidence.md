...
| --- | --- | --- | --- | --- | --- | --- |
| `result-binding` | result binding | `check --only runtime` | 1 | 49 runtime binding rows | `PM095` | 14 |
...
- `tests/promise_machine_coverage.json`, SHA-256 `0af078685f91267d5642131295c52953cab977cd3cd8c865128f0fbdcfdfc8cd`, 270022 bytes
...
- `docs/promise-machine/obligation-gates/evaluation-run.json`, SHA-256 `44f8eb4886c9cea26ccec7a83854c658cfd3995e480675fde3d6bbe22d2cc856`, 3231 bytes
