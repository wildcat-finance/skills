...
ADR-056 owns the durable hosted-gate choice; fixture qualifications stay beside
the specimens.
...
ADR-056 and the workflow are the decision and operational homes.
...
stop. hypomnema: ADR-056 names why both contexts are required; live GitHub owns
