...
| --- | --- | --- |
| Codex | Native Wildcat marketplace package; manual local start | No checked one-click Atlas launcher |
| Claude Code | Native Wildcat marketplace package; manual local start | No checked one-click Atlas launcher |
| GitHub Copilot | Repository instructions plus the exact Atlas prompt | No checked one-click Atlas launcher |
| Cursor | File-reading or CLI route with the exact Atlas prompt | No checked one-click Atlas launcher |
| Gemini CLI | Agent Skills or file-reading route with the exact Atlas prompt | No checked one-click Atlas launcher |
| Windsurf | File-reading route with the exact Atlas prompt | No checked one-click Atlas launcher |

See [`INSTALL.md`](../INSTALL.md) for the current install commands. Cline and
Roo Code are not presented as launch options because this repository has no
checked Atlas hand-off for either one.
