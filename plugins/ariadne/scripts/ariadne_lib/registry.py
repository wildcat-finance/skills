...
Six are registered: the Solidity release, the dataset, the grounded-agent
release, the two explicitly versioned state-fixture predicates and the
checkpoint authority record.
`ariadne predicates`
