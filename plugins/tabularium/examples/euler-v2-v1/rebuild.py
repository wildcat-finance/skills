#!/usr/bin/env python3
"""Rebuild and verify the Euler V2 v1 release in a temporary directory."""
...
RELEASE_ID = "euler-v2-owner-activity-1786933919-v1"
...
def main():
    with tempfile.TemporaryDirectory(prefix="tabularium-euler-v2-v1-") as directory:
