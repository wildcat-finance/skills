#!/usr/bin/env python3
"""Rebuild and verify the Aave v4 v1 release in a temporary directory."""
...
RELEASE_ID = "aave-v4-mainnet-credit-window-v1"
...
def main():
    with tempfile.TemporaryDirectory(prefix="tabularium-aave-v4-v1-") as directory:
