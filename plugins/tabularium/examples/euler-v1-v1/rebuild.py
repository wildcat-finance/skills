#!/usr/bin/env python3
"""Rebuild and verify the Euler v1 v1 release in a temporary directory."""
...
RELEASE_ID = "euler-v1-borrow-block-14531589-v1"
...
def main():
    with tempfile.TemporaryDirectory(prefix="tabularium-euler-v1-v1-") as directory:
