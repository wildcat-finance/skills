...
- No chain-proof claim. Captured logs and block hashes are provider-reported;
  neither the block nor each event is independently proved against Ethereum here.
