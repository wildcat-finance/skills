"""The Tabularium unittest report stays fresh and inside its worktree.
...
class RunnerTests(unittest.TestCase):
    ...
    def test_outside_existing_and_symlinked_report_targets_are_refused(self):
        with tempfile.TemporaryDirectory(prefix="tabularium-runner-") as directory:
