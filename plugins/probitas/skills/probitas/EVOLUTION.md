...
- Current version: `probitas-v1.4.0`
...
| `probitas-v1.3.0` | generation | `midnight-secondary-close-attribution` | `f947d2653e33240e5f2d368cc6c952af5939c0187741fba04896a6d32aa9cbe2` | [skills#410](https://github.com/wildcat-finance/skills/issues/410), [statement tests](../../tests/test_statement.py) | A successful verify run can emit one canonical unsigned statement whose statement-level subject array binds the exact checked dossier and evidence bytes. Five claims record the passed gates against the dossier digest, and Ariadne keeps its unregistered-predicate boundary visible. The held frontier and next Fiat job are unchanged. |
| `probitas-v1.4.0` | generation | `midnight-secondary-close-attribution` | `f947d2653e33240e5f2d368cc6c952af5939c0187741fba04896a6d32aa9cbe2` | [skills#392](https://github.com/wildcat-finance/skills/issues/392), [comparison tests](../../tests/test_delta.py) | Two gate-checkable schema 2 evidence files for the same subject can now produce a deterministic Markdown or JSON change report. Input digests, coverage changes, opened and closed gaps, sourced record differences and inferred-address findings remain distinct. The roles do not assert chronology, causation, completeness, a score or a Wildcat decision. The held frontier and next Fiat job are unchanged. |
