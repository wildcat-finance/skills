...
| --- | --- | --- | --- | --- | --- |
| `probitas-demo-v0.1.0` | baseline | `dossier-over-a-declared-counterparty` | `f13aee27da8d20b9ef1a899eec17eb296fcc389fbd61e4ba0525b2bbb8c854fb` | `docs/decisions/ADR-068-govern-real-data-demonstrations-separately.md` | The demonstration lane starts here. Status `constructed` is decided by the material inputs above, not by the prose. |
