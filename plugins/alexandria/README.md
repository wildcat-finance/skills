...
Synkrisis compares validated observations from several agent runs. Its four
operations build a checked cohort, infer bounded findings, render a fixed
report and verify the whole path. It cannot reinterpret an Alexandria release
or authorise a new capture.
