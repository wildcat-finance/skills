...
Each module below names its own venue in a `VENUE` constant and supplies
`validate_registry` and `gaps` for that venue's deployment registry. `VENUES`
...
from . import compound_v3

_MODULES = (compound_v3,)
