...
3. If another agent hands over a local checkpoint, run `hexctl checkpoint
...
- Evidence: The out-of-band outer SHA-256, closed content manifest, capsule manifest digest, complete-history bundle, pinned signature and trailer checks, identity join, hostile archive tests, clean-machine transcript and six recorded budget measurements.
