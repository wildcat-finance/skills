...
| --- | --- | --- | --- | --- | --- |
| `ephoros-demo-v0.1.0` | baseline | `signals-from-a-running-step` | `4bc9af7ed4daa6f066ced6728fe4e465131d1e6875e35772221ddfa98c77d6b1` | `docs/decisions/ADR-068-govern-real-data-demonstrations-separately.md` | The demonstration lane starts here. Status `constructed` is decided by the material inputs above, not by the prose. |
