...
- the joined success-criteria demonstration, which runs the successor controller in a disposable Git-backed fixture and records its bounded positive, refusal and read-only replay outcomes ([`proof.py`](../../docs/protasis-success-criteria/proof.py) and its [`demonstration.md`](../../docs/protasis-success-criteria/demonstration.md)); it does not claim criterion sufficiency or semantic correctness;
