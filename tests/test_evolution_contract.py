...
class EvolutionContractTests(unittest.TestCase):
    ...
    def test_fiat_state_shape_frontier_holds_the_task_identity_successor(self):
        ...
        published_predecessor = history_rows(ledger)[-3]
        self.assertEqual(published_predecessor["version"], "fiat-v5.25.1")
        self.assertIn("skills#495", published_predecessor["evidence"])
        self.assertIn(
            "fiat-run-worktree-study.md", published_predecessor["evidence"]
        )
