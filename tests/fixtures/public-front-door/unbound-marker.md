<!-- front-door-specimen: expect="FD17" reason="a marker binds no governed demonstration record" -->
<p align="center">
...
<!-- front-door:demo skill="wraith" claim="{{claim:lantern}}" digest="{{digest:lantern}}" -->
