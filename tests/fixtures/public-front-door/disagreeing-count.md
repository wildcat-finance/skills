<!-- front-door-specimen: expect="FD26" reason="a count claim disagrees with both manifests and tree discovery" -->
<p align="center">
...
in <!-- front-door:count key="plugins" -->16 plugins. No id here is
