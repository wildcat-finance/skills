# Second demonstration ledger

A second skill claiming the same claim id as the valid specimen.

- Current demonstration version: `second-demo-v0.1.0`
