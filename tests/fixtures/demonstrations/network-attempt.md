# Network attempt demonstration ledger

The child opens a socket, swallows the refusal, prints its line and exits 0. The runner refuses it anyway.
  ...
  "commands": [
    {
      ...
      "argv": [
        "python3",
        "-c",
        "with __import__('contextlib').suppress(Exception): print('swallowed'); __import__('socket').socket()"
      ],
      "expect_exit": 0
    }
  ],
